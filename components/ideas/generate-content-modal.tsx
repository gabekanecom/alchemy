...
export function GenerateContentModal({
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      alert(
        `✅ Content generation started!\n\n${selectedPlatforms.length} content pieces are being generated.\n\nCheck the Content Queue to monitor progress.`
      );
                    ...
                    <div className="space-y-2">
                      <label className="flex items-center gap-2">
                        <input
                          ...
                          checked={aiModel === "claude-sonnet-4.5"}
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="flex gap-2 mb-4">
                <Button size="sm" variant="outline" onClick={selectAllPlatforms} disabled={isGenerating}>
                  All
                </Button>
                <Button size="sm" variant="outline" onClick={selectSocialPlatforms} disabled={isGenerating}>
                  Social
                </Button>
                <Button
                  size="sm"
