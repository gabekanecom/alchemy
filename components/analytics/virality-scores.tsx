...
export function ViralityScores({ timeRange, brandId }: ViralityScoresProps) {
  ...
  return (
    <div className="grid grid-cols-1 gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="bg-grey-850 border-grey-700 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-grey-400">Average Score</p>
        ...
        <Card className="bg-grey-850 border-grey-700 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-grey-400">Score Accuracy</p>
        ...
        <Card className="bg-grey-850 border-grey-700 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-grey-400">Viral Content (80+)</p>
              <p className="text-3xl font-bold text-white mt-2">
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4 flex-1">
                  <div className="flex items-center justify-center w-8 h-8 rounded-full bg-grey-800 text-grey-400 font-bold">
                    #{index + 1}
                  </div>
                  <div className="flex-1">
                    <Link
                      href={`/content/${content.id}/edit`}
                      className="text-white hover:text-gold-400 font-medium line-clamp-1"
                    >
                      {content.title}
                    </Link>
                ...
                <div className="flex items-center gap-6">
                  <div className="text-center">
                    <p className="text-xs text-grey-400">Predicted</p>
                  ...
                  {content.actualScore && (
                    <div className="text-center">
                      <p className="text-xs text-grey-400">Actual</p>
                  ...
                  <div className="text-center">
                    <p className="text-xs text-grey-400">Views</p>
      ...
      <Card className="bg-grey-850 border-grey-700 p-6">
        <h3 className="text-lg font-semibold text-white mb-4">Average Virality Score Trend</h3>
